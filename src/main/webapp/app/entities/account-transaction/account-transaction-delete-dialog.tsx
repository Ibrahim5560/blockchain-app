...
export const AccountTransactionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="blockchainApp.accountTransaction.delete.question">
        <Translate contentKey="blockchainApp.accountTransaction.delete.question" interpolate={{ id: accountTransactionEntity.id }}>
