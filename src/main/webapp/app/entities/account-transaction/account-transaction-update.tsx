  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="blockchainApp.accountTransaction.home.createOrEditLabel" data-cy="AccountTransactionCreateUpdateHeading">
            <Translate contentKey="blockchainApp.accountTransaction.home.createOrEditLabel">Create or edit a AccountTransaction</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('blockchainApp.accountTransaction.transactionName')}
              ...
              />
              <ValidatedField
                label={translate('blockchainApp.accountTransaction.amount')}
              ...
              <ValidatedField
                ...
                label={translate('blockchainApp.accountTransaction.clientAccount')}
                type="select"
              >
                <option value="" key="0" />
                {clientAccounts
