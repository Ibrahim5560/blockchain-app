  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="blockchainApp.clientAccount.home.createOrEditLabel" data-cy="ClientAccountCreateUpdateHeading">
            <Translate contentKey="blockchainApp.clientAccount.home.createOrEditLabel">Create or edit a ClientAccount</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('blockchainApp.clientAccount.accountNumber')}
              ...
              />
              <ValidatedField
                label={translate('blockchainApp.clientAccount.owner')}
              ...
              />
              <ValidatedField
                label={translate('blockchainApp.clientAccount.balance')}
              ...
              />
              <ValidatedField
                label={translate('blockchainApp.clientAccount.creationDate')}
