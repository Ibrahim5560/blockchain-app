  ...
  return (
    <div>
      <h2 id="client-account-heading" data-cy="ClientAccountHeading">
        <Translate contentKey="blockchainApp.clientAccount.home.title">Client Accounts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="blockchainApp.clientAccount.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/client-account/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="blockchainApp.clientAccount.home.createLabel">Create new Client Account</Translate>
          </Link>
        </div>
      </h2>
        ...
        {clientAccountList && clientAccountList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="blockchainApp.clientAccount.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="blockchainApp.clientAccount.home.notFound">No Client Accounts found</Translate>
            </div>
          )
        )}
      </div>
